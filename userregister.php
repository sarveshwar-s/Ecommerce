...
<div class="container">
    <a href="/organic/index.php" class="btn btn-primary">BACK</a>
</div>
<!-- ====================================section================================================= -->
...
<!-- password -->
<input type="password" name="password"  id="defaultContactFormEmail" class="form-control mb-4" placeholder="Password">
<!-- mobile number -->
<input type="text" name="mobilenumber" id="defaultContactFormEmail" class="form-control mb-4" placeholder="Mobile number">



<!-- Message -->
<div class="form-group">
    <textarea name="address" class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" placeholder="Message"></textarea>
</div>
<div class="form-group">
<input type="text" name="pincode" id="defaultContactFormEmail" class="form-control mb-4" placeholder="Pincode">
</div>

<!-- Send button -->
<button class="btn btn-info btn-block" type="submit" name="newprofile">Register</button>
