...
<p class="h4 mb-4">Vendor Registeration Page</p>
...
<div class="form-group">
<input type="text" name="city" id="defaultContactFormEmail" class="form-control mb-4" placeholder="City">
</div>
<div class="form-group">
...
<!-- Send button -->
<button class="btn btn-info btn-block" type="submit" name="newvendor">Register</button>
