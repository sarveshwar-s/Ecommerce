...
<div class="form-group">
   <select class="form-control" name="productid">
      ...
      ?>
            <option><?php echo $product_id; ?></option>
    <?php } ?>	
		</select> 
</div>
   <div class="form-group">
   ...
   <center>
   <div class="form-group">
   <input type="submit" name="image_submit" class="btn btn-success">
   </div>
   </center>
</form>
</div>
...
<?php 
  if(isset($_POST['image_submit'])){
    ...
    //$query2 = "INSERT INTO `product_images`(`p_id`, `iname`) VALUES ($product_id,'$imageurl')";
    $query2 = "UPDATE `product` SET `imagename` = '$imageurl' where pid=$product_id";
